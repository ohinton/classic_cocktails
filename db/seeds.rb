...
recipe_list = [
  ...
  ["Mary Pickford", "Add 1.5 oz white rum, 1.5 oz pineapple juice, 1 tsp Grenadine and 6 drops Maraschino liqueur to a cocktail shaker and fill with ice. Shake and strain into a chilled sugar rimmed martini glass. Garnish: none.", 2, "http://bit.ly/2aNbzFF"],
  ...
  ["The Falsey", "Shake 2 oz vodka, a dash of dry vermouth, a dash of sweet vermouth, 2 oz fresh orange juice, and 1 egg white vigorously over ice. Strain into a chilled rocks glass.", 2, "http://bit.ly/2aqRnwj"],
  ["Mike Goren Brave Bull", "Fill rocks glass with ice and add .5 oz of tequila and .5 oz of coffee liqueur. Optional: if you are brave, add a small splash of soda, make it a very small splash!.", 7, "http://bit.ly/2agCN5U"],
