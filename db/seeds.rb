...
recipe_list = [
  ...
  ["Mary Pickford", "Add 1.5 oz white rum, 1.5 oz pineapple juice, 1 tsp Grenadine and 6 drops Maraschino liqueur to a cocktail shaker and fill with ice. Shake and strain into a chilled martini glass. Garnish: none.", 2, "http://bit.ly/2aNbzFF"],
  ...
  ["Stabby Lambda", "Add 3oz of high end scotch and serve neat. Garnish: Sword stabbed through an ice cube!", 7, "http://bit.ly/2akAOy9"],
  ...
  ["Capybara", "Pour 3 oz of brandy into a brandy snifter and enjoy", 9, "http://bit.ly/2ae9zWm"],
  ["Boulevardier", "Add 1 oz Campari, 1 oz Sweet vermouth, and 1.25 oz Bourbon to a rocks glass filled with ice and stir to combine.  Pour into a rocks glass and garnish with an orange twist. To serve the drink up, add all the ingredients to a mixing glass and fill with ice.", 7, "http://bit.ly/2akBbJg"],
  ...
  ["Pimm’s Cup", "To make a Pimm's cup, first add 3 oz Champagne, 2 oz Pimm's No. 1, 1  cucumber slices, 1  Strawberry, hulled and cut into quarters, half Orange slice, 1  Lemon slice and 6  Mint leaves to a highball glass filled with ice and stir to combine.", 10, "http://bit.ly/2aejmvB"],
  ...
  ["Tom Collins", "Add .75 oz fresh lemon juice, .75 oz simple syrup (one part water, one part sugar) and 1.5 oz gin to a shaker and fill with ice. Shake well and strain into a highball or Collins glass filled with fresh ice. Top with club soda and garnish with a lemon wheel and a cherry.", 10, "http://bit.ly/2afdur4"],
  ...
  ["Bourbon Mixin", "Gently muddle slices of pineapple, orange and lemon, add 2 oz bourbon, and .5 oz of orange liqueur. Ice and mix well. Garnish with a sprig of mint and serve with a side of SASS.", 7, "http://bit.ly/2aek6AS"],
  ["Yukihiro Matsumoto Daiquiri", "Add .75 oz white rum, .5 oz cherry liqueur, a splash of grapefruit and a splash of lime juice to shaker filled with ice. Shake sharply and strain into a chilled martini glass.", 1, "http://bit.ly/2ajWM7j"],
  ["Hampton Catlin’s Silk Stocking", "Add .75 oz tequila, .5 oz white creme de cacao, a splash of grenadine, .5 oz heavy cream to blender. Add two scoops of crushed ice and blend for 20 seconds. Pour into a bucket glass, garnish with two raspberries and serve with two straws.", 2, "http://bit.ly/2akL8Gl"],
  ["The Falsey", "Shake 2 oz vodka, a dash of dry vermouth, a dash of sweet vermouth, 2 oz fresh orange juice, and 1 egg white vigorously over ice. Strain into a chilled martini glass.", 2, "http://bit.ly/2aqRnwj"],
  ["The Mike", "Fill rocks glass with ice and add .5 oz of tequila and .5 oz of coffee liqueur. Optional: add a small splash of soda.", 7, "http://bit.ly/2agCN5U"],
  ["Truthy", "Open bottle of real gin and drink", 11, "/img/realgin.jpg"]
]
